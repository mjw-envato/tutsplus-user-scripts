...
// Change log:
//
// 06/20/2023     Added the ability to clear out the reports and added the TubeBuddy report id for proper finding on the main page.
//                @raguay
...
// Inputs:        none
//
var downloadTSV = null;
var clearReport = null;
...
function reportListing() {
  ...
  if(reports) {
    ...
    var clearReport = $(viewReport).clone();
    clearReport.attr("id", "clear-report");
    clearReport.attr("data-reportid", "");
    ...
    clearReport.on('click', e => {
      ...
      //
      // Remove the buttons if they exists.
      //
      if(downloadTSV !== null) downloadTSV.remove();
      if(clearReport !== null) clearReport.remove();
    });
  }
};
